/**
 * Explorer Agent - Codebase Search Specialist
 *
 * Fast parallel search for finding code patterns, files, and implementations.
 * Answers: "Where is X?", "Which files contain Y?", "Find the code that does Z"
 */
