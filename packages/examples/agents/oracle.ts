 ...
 *
 * Deep reasoning for architecture decisions, code analysis, debugging strategy,
 * and engineering guidance. Provides actionable recommendations with effort estimates.
 */
